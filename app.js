...
const TRANSLATIONS = {
  en: {
    ...
    staffDrinksPickerHint: "2. Pick the drink",
    staffDrinksRecipientHint: "1. Who's it for?",
    ...
    settingsStoreOverview: "Store Overview",
  ...
  mk: {
    ...
    staffDrinksPickerHint: "2. Изберете пијалак",
    staffDrinksRecipientHint: "1. За кого е ова?",
    ...
    settingsStoreOverview: "Преглед на продавницата",
  ...
  sq: {
    ...
    staffDrinksPickerHint: "2. Zgjidh pijen",
    staffDrinksRecipientHint: "1. Për kë është kjo?",
    ...
    settingsStoreOverview: "Përmbledhje e Dyqanit",
